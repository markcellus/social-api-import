...
exports.Vine = exports.Twitter = exports.Tumblr = exports.Instagram = exports.Facebook = undefined;

var _facebook = require('./src/facebook');

var _facebook2 = _interopRequireDefault(_facebook);

var _instagram = require('./src/instagram');

var _instagram2 = _interopRequireDefault(_instagram);

var _tumblr = require('./src/tumblr');

var _tumblr2 = _interopRequireDefault(_tumblr);

var _twitter = require('./src/twitter');

var _twitter2 = _interopRequireDefault(_twitter);

var _vine = require('./src/vine');
...
var BaseApi = function () {
  ...
  _createClass(BaseApi, [{
    ...
    value: function unload() {
      ...
      return _resourceManagerJs2.default.unloadScript(this._script);
    }
    ...
    key: '_loadScript',
    value: function _loadScript(path) {
      this._script = path;
      return _resourceManagerJs2.default.loadScript(this._script);
    }
    ...
    key: '_handleLoadApi',
    value: function _handleLoadApi(options) {
      return _es6Promise.Promise.resolve();
    }
  }]);
...
var Facebook = function (_BaseApi) {
    _inherits(Facebook, _BaseApi);
    ...
    _createClass(Facebook, [{
        ...
        value: function load() {
            ...
            return _get(Object.getPrototypeOf(Facebook.prototype), 'load', this).call(this, options);
        }
...
var Instagram = function (_BaseApi) {
    _inherits(Instagram, _BaseApi);

    function Instagram() {
        _classCallCheck(this, Instagram);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(Instagram).apply(this, arguments));
    }
    ...
    _createClass(Instagram, [{
         ...
         * @private
         */
        value: function _handleLoadApi() {
            return this._loadScript('//platform.instagram.com/en_US/embeds.js').then(function () {
...
var Tumblr = function (_BaseApi) {
    _inherits(Tumblr, _BaseApi);

    function Tumblr() {
        _classCallCheck(this, Tumblr);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(Tumblr).apply(this, arguments));
    }
    ...
    _createClass(Tumblr, [{
        ...
        value: function load() {
            ...
            return _get(Object.getPrototypeOf(Tumblr.prototype), 'load', this).call(this, options);
        }
        ...
        value: function _handleLoadApi(options) {
            ...
            var callbackMethod = 'onTumblrReady';

            // we're arbitrarily choosing the "/posts" endpoint to prevent getting a 404 error
            var scriptUrl = '//api.tumblr.com/v2/blog/' + options['base-hostname'] + '/posts?' + 'api_key=' + options.api_key + '&' + 'callback=' + callbackMethod;

            return new _es6Promise.Promise(function (resolve) {
                window[callbackMethod] = function () {
                    resolve();
                };
                _this2._loadScript(scriptUrl);
            });
        }
    }]);
...
var Twitter = function (_BaseApi) {
    _inherits(Twitter, _BaseApi);
    ...
    _createClass(Twitter, [{
        ...
        value: function _handleLoadApi() {
            ...
            return new _es6Promise.Promise(function (resolve) {
                ...
                _this2._loadScript('https://platform.twitter.com/widgets.js');
            });
        }
    }]);
...
var Vine = function (_BaseApi) {
  _inherits(Vine, _BaseApi);

  function Vine() {
    _classCallCheck(this, Vine);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(Vine).apply(this, arguments));
  }
